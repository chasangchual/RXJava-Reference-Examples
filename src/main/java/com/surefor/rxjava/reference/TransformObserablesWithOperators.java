...
public class TransformObserablesWithOperators {
    ...
    public static void transformWithMap() {
        Observable<Integer> observable = getObservable1() ;
        observable.map((i) -> i * -1).observeOn(Schedulers.newThread()).subscribe((i) -> {
            try {
                Thread.sleep(100) ;
    ...
    public static void transformWithZip() {
        ...
        Observable.zip(observable2.observeOn(Schedulers.newThread()), observable1.observeOn(Schedulers.newThread()), new Func2<Integer, Integer, String>() {
            @Override
    ...
    public static void transformWithCombileLatest() {
        ...
        Observable.combineLatest(observable1.observeOn(Schedulers.newThread()), observable2.observeOn(Schedulers.newThread()), new Func2<Integer, Integer, String>() {
            @Override
            public String call(Integer i1, Integer i2) {
                return String.valueOf(i1) + " - " + String.valueOf(i2) ;
            }
        }).observeOn(Schedulers.newThread()).subscribe((s) -> System.out.println(s)) ;
    }

    public static void transformWithCombineLatestWithFlatMap() {
        Observable<Integer> observable1 = getObservable1().observeOn(Schedulers.newThread()).flatMap(new Func1<Integer, Observable<Integer>>() {
            @Override
        ...
        Observable<Integer> observable2 = getObservable2().observeOn(Schedulers.newThread()).flatMap(new Func1<Integer, Observable<Integer>>() {
            @Override
            public Observable<Integer> call(Integer i) {
                return Observable.just(i) ;
            }
        ...
        }).observeOn(Schedulers.newThread()).subscribeOn(Schedulers.newThread()).subscribe((s) -> System.out.println(s)) ;
    }
    ...
    public static void main(String[] args) {
        ...
        TransformObserablesWithOperators.transformWithCombineLatestWithFlatMap();
